            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb m-0 p-0">
                        ...
                        <li class="breadcrumb-item text-muted active" aria-current="page">Manage Pesanan</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs nav-bordered mb-2">
                        ...
                        <li class="nav-item filter-status" data-filter="aktif">
                            <a href="#home" data-toggle="tab" aria-expanded="false" class="nav-link">
                                <i class="mdi mdi-home-variant d-lg-none d-block mr-1"></i>
                                <span class="d-none d-lg-block">Pesanan Baru</span>
                            </a>
                        </li>
                        <li class="nav-item filter-status" data-filter="nonaktif">
                            <a href="#profile" data-toggle="tab" aria-expanded="true" class="nav-link">
                                <i class="mdi mdi-account-circle d-lg-none d-block mr-1"></i>
                                <span class="d-none d-lg-block">Diproses</span>
                            </a>
                        </li>
                        <li class="nav-item filter-status" data-filter="nonaktif">
                            <a href="#profile" data-toggle="tab" aria-expanded="true" class="nav-link">
                        ...
                        <li class="nav-item filter-status" data-filter="nonaktif">
                            <a href="#profile" data-toggle="tab" aria-expanded="true" class="nav-link">
                                <i class="mdi mdi-account-circle d-lg-none d-block mr-1"></i>
                                <span class="d-none d-lg-block">Dibatalkan</span>
                            </a>
                        </li>
                    </ul>
